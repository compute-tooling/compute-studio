...
def test_paramdisplayer(comp_inputs, mockproject, valid_meta_params):
    """
...
def test_paramparser(comp_inputs, valid_meta_params, mockproject):
    """
