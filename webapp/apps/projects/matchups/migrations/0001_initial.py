    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inputs', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='outputs', to='matchups.MatchupsInputs')),
                ('profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='matchups_matchupsrun_runs', to='users.Profile')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='matchups_matchupsrun_runs', to='users.Project')),
                ('sponsor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='matchups_matchupsrun_sponsored_runs', to='users.Profile')),
            ],
            options={
                'abstract': False,
            },
