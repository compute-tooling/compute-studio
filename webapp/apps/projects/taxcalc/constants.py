...
INCOME_BINS_TOOLTIP = ("Tax units are binned according to the income group to "
                       "which they belong.")
INCOME_DECILES_TOOLTIP = (" Tax units are binned according to the income "
                          "decile to which they belong.")
FISCAL_CURRENT_LAW = "Fiscal Current Law"
FISCAL_REFORM = "Fiscal Reform tooltip"
FISCAL_CHANGE = "Fiscal Change tooltip"
METR_TOOLTIP = ("Marginal effective tax rate on new investments. The METR "
                "includes the impact of the first level of taxation on the "
                "incentives to invest.")
METTR_TOOLTIP = ("Marginal effective total tax rate on new investments. The "
                 "METTR includes the impact of all levels of taxation (both on"
                 " business entities and savers) on the incentives to invest.")
